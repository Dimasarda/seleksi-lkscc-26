document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            const response = await fetch('https://hfq2158yn5.execute-api.us-west-2.amazonaws.com/dev/app1', { 
                method: 'POST',
                headers: {
    ...
    async function fetchData() {
        try {
            const response = await fetch('https://hfq2158yn5.execute-api.us-west-2.amazonaws.com/dev/app1'); // Ganti dengan GET endpoint
